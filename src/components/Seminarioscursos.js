...
function Seminarioscursos() {
  ...
  const addToCart = (id) => {
    ...
    const fechaseleccionada = JSON.parse(localStorage.getItem("fechaseleccionada"));
  ...
  return (
    <div>
       ...
       {/* <img  class="w-full h-32" src="https://res.cloudinary.com/dwhhfl68n/image/upload/v1651349545/incapresources/universe-1566161_1920_kx0liz.jpg" alt="banner" /> */}
          ...
          ¡Hola <span className='text-orange-500'>{datosusuario.nombres}</span> te damos la bienvenida!
          </h1>
        </div>
      </header>
            ...
            <div class="border-8 border-orange-200 rounded-lg h-1000 ">
              <div class="bg-white">
                <div class="max-w-2xl mx-auto py-10 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                  ...
                  A continuación encontrarás los cursos disponibles para la fecha elegida, <p className='text-orange-500'>{fechaseleccionada}</p>
                  </h2>
